...
class TransferOwnershipFlow (
    ...
    override fun call(): SignedTransaction {
        ...
        if(ourIdentity != inputModelState.owner){
            throw IllegalArgumentException("Only the owner can transfer ownership of a model.")
        }

        // finish building tx
        val outputModelState = inputModelState.replaceOwner(newOwner)
        val commandData = ModelContract.Commands.TransferOwnership()
